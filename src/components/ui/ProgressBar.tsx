...
export function ProgressBar({
  ...
  return (
    <div
      ...
      className={cn('h-3 w-full overflow-hidden rounded-full bg-ink/10 dark:bg-ink/15', className)}
    >
      <div
        className={cn(
          'h-full rounded-full transition-[width] duration-700 ease-out animate-progress-fill',
          tones[tone],
        )}
        style={{ width: `${pct}%` }}
      />
